      ...
      Item {
        ...
        Keys.onPressed: function(event) {
          ...
          if (event.key === Qt.Key_Delete) {
            ...
            if (pasted) root.setFilter(root.filterText + pasted)
            event.accepted = true
            ...
            event.accepted = true
                     ...
                     || (event.modifiers === Qt.ControlModifier && (event.key === Qt.Key_M || event.key === Qt.Key_L))) {
            if (root.dmenuActive) {
      ...
      Column {
        ...
        Rectangle {
          ...
          Text {
            ...
            anchors.right: parent.right
            anchors.rightMargin: headerBack.visible ? headerBack.width : 0
